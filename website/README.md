# ignition-cli documentation site
...
Pull requests build the docs and check internal links. Main commits deploy to https://thethoughtagen.github.io/ignition-cli/ through GitHub Pages. Set the repository's Pages build source to GitHub Actions before its first deployment.
