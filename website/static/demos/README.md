...
```sh
agg --font-family Menlo --font-size 14 --fps-cap 10 --speed 1.2 --idle-time-limit 2 --last-frame-duration 3 cli.cast cli.gif
agg --font-family Menlo --font-size 14 --fps-cap 10 --speed 1.2 --idle-time-limit 2 --last-frame-duration 3 tui.cast tui.gif
