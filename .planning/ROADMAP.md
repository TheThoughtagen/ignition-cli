...
- [~] **Phase 6: TUI Cockpit** (In progress — 4/6 plans: 06-01 foundation + 06-02 dashboard + 06-03 logs/alarms + 06-04 tags shipped) - Ratatui cockpit exposing every CLI action: dashboard, log tail, tag browser with live watch, alarm panel, project browser, profile switcher
