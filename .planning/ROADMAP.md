...
**Plans**: 4 plans + 2 UAT gap-closure plans (original 4 sequential waves 1→4 — every plan grows the cli.rs/main.rs/routes.rs choke files, the Phase 1–4 pattern; gap closure: 07-05 wave 1, 07-06 wave 2 — sequenced because both edit classify.rs + contract_eam.rs)
