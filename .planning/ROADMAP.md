...
- [x] **Phase 6: TUI Cockpit** (Complete 2026-08-28 — 6/6 plans) - Ratatui cockpit exposing every CLI action: dashboard, log tail, tag browser with live watch, alarm panel, project browser, rig screen; CLI<->TUI coverage CI-enforced (tui_coverage clap-tree walk)
